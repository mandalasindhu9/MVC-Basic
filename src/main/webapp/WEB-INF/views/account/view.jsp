...
<div class="container">
	...
	<div class="span-12 last">	
		...
		<a href="/mvc-basic/account/<c:out value="${account.id}"/>/edit"><button type=submit>Edit Form</button></a>
		<a href="/mvc-basic/account/<c:out value="${account.id}"/>/delete"><button type=submit>Delete Form</button></a>
